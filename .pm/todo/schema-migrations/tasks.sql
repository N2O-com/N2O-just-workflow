...
('schema-migrations', '01-schema-migrations.md', 2,
 ...
 'infra', 'bash',
 3.0, 'medium', 'Core migration logic, must handle edge cases: empty migrations dir, already-applied migrations, multiple pending migrations',
...
('schema-migrations', '01-schema-migrations.md', 3,
 ...
 'infra', 'bash',
 3.0, 'high', 'Parsing SQL CREATE TABLE statements and diffing column lists is non-trivial; need to handle types, defaults, constraints',
