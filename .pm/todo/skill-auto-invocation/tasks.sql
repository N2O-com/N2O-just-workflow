...
('skill-auto-invocation', '01-skill-auto-invocation.md', 1,
 ...
 'docs', 'pm-agent',
 2.0, 'medium', 'Requires understanding Claude Code skill matching behavior — trigger wording matters',
...
('skill-auto-invocation', '01-skill-auto-invocation.md', 2,
 ...
 'infra', 'pm-agent',
 2.5, 'medium', 'Must integrate with existing CLAUDE.md template without breaking detect-project auto-trigger; config changes must work with n2o init and sync',
