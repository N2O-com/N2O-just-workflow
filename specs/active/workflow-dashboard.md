...
2. **Mobile**: Need mobile view, or desktop-only for v1? See also Goal 8 (Ubiquitous Access) in `n2o-roadmap.md` — the dashboard is the natural foundation for mobile contribution surfaces.
